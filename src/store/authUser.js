...
// 초기 상태 선언
/***
 * @param { _c_logIdx : Int , _c_logSign  : Int , _c_logCIdx : Int , _c_logAdTp : Int , _c_logNmCnt : Int , _c_logUNmCnt : Int, _c_logNm : String , _c_logMobile : String , _c_logPhone : String , _c_logEmail : String , _c_logPosi : String , _c_logDept : String , isLogin : Boolean }
 */
const initialState = {
  _c_logIdx: 0,
  _c_logSign: 0,
